...
public class HangmanFx extends Application {
	...
	private void lost() {
		...
		Label win = new Label(theWord+" WAS THE COUNTRY");
	...
	public void start(Stage primaryStage) throws Exception {
		...
		H2 h2=new H2();
		//h2.info("Guess a name of a country");

		Label heading3 = new Label(h2.info("Guess a name of a country!"));
		heading3.setFont(new Font("Arial Rounded MT", 20));
		heading3.setLayoutX(280);
		heading3.setLayoutY(100);
		...
		root1.getChildren().addAll(mvs2, heading1,heading3, pause, exit2, gridPane, pane, thing, tfGuess, restart,
	...
	private void playGame() {
		...
		//HERE
		guess = h.getOnlyFirstLetter(guess);
		...
		tfLettersGuessed.setText(guessedLetters.toString());
         ...
         else if (!isGood(guess,text,theWord)) {
		...
		// No more guesses - GAME OVER
			...
			tfGuess.setDisable(h.isOver(left));
			lost.get(0).setVisible(h.isOver(left));
			// GAME OVER
